...
void PointTester::testInvalid() {
    ...
    Point q0(INFINITY, INFINITY, INFINITY);
    if (q0.isValid())
    {
        std::cout << "Failure in validating Point(\"INFINITY,INFINITY,INFINITY\") isValid()="
                  << q0.isValid()
                  << " x=" << q0.getX()
                  << " y=" << q0.getY()
                  << " z=" << q0.getZ()
    ...
    Point q1(1,2,INFINITY);
    if (q1.isValid())
    {
        std::cout << "Failure in validating Point(\"1,2,INFINITY\") isValid()="
                  << q1.isValid()
                  << " x=" << q1.getX()
                  << " y=" << q1.getY()
                  << " z=" << q1.getZ()
    ...
    Point q2(1,INFINITY,3);
    if (q2.isValid())
    {
        std::cout << "Failure in validating Point(\"1,INFINITY,3\") isValid()="
                  << q2.isValid()
                  << " x=" << q2.getX()
                  << " y=" << q2.getY()
                  << " z=" << q2.getZ()
    ...
    Point q3(INFINITY,2,3);
    if (q3.isValid())
    {
        std::cout << "Failure in validating Point(\"INFINITY,2,3\") isValid()="
                  << q3.isValid()
                  << " x=" << q3.getX()
                  << " y=" << q3.getY()
                  << " z=" << q3.getZ()
